...
{
    const PermissionName = MoneyTransaction::class;
    public function viewAny(User $user): bool
    {
        return $user->hasPermission("ViewAny", self::PermissionName);
    }

    public function view(User $user, MoneyTransaction $moneyTransaction): bool
    {
    ...
    public function update(User $user, MoneyTransaction $moneyTransaction): bool
    {
        return $user->hasPermission("Update", self::PermissionName);
    }

    public function delete(User $user, MoneyTransaction $moneyTransaction): bool
    {
    ...
    public function restore(User $user, MoneyTransaction $moneyTransaction): bool
    {
    ...
    public function forceDelete(User $user, MoneyTransaction $moneyTransaction): bool
    {
