    ...
    public function run(): void
    {
        $bookings = [
            ...
            [
                ...
                'booking_status_id' => 3, // Tests how system handles cancellations
                'rated' => false,
            ],
            [
                'user_id' => 3,
            ...
            [
                ...
                'booking_status_id' => 5, // Will trip your booking_status_id accessor to 'rented'
                'rated' => false,
            ],
            [
                'user_id' => 4,
            ...
            [
                ...
                'booking_status_id' => 2, // Paid and ready for pickup next week
                'rated' => false,
            ],
            [
                'user_id' => 4,
                ...
                'booking_status_id' => 1, // Awaiting admin approval
                'rated' => false,
            ],
        ];
